...
def main():
    ...
    arg_parser.add_argument('--path', type=str, default='C:/Users/psbsa/Documents/Visual_Studio_2019/Projects/unrealPraticeServer/GameServer/GameDB.xml', help='Xml Path')
